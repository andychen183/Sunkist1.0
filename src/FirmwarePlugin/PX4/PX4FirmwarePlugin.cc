...
static const struct Modes2Name rgModes2Name[] = {
    ...
    { PX4_CUSTOM_MAIN_MODE_AUTO,        PX4_CUSTOM_SUB_MODE_AUTO_READY,     "Auto: Ready",       true },
    { PX4_CUSTOM_MAIN_MODE_AUTO,        PX4_CUSTOM_SUB_MODE_AUTO_TAKEOFF,   "Auto: Takeoff",       true },
    ...
    { PX4_CUSTOM_MAIN_MODE_AUTO,        PX4_CUSTOM_SUB_MODE_AUTO_LAND,      "Auto: Landing",          true },
};
...
bool PX4FirmwarePlugin::setFlightMode(const QString& flightMode, uint8_t* base_mode, uint32_t* custom_mode)
{
    ...
    *custom_mode = 0;
    ...
    for (size_t i=0; i<sizeof(rgModes2Name)/sizeof(rgModes2Name[0]); i++) {
      ...
      qWarning() << "sizeof(rgModes2Name) " << sizeof(rgModes2Name)<< " /sizeof(rgModes2Name[0]) = " << sizeof(rgModes2Name[0])<< " rgModes2Name= " << pModes2Name->name;
 qWarning() << "flight base_mode: " << MAV_MODE_FLAG_CUSTOM_MODE_ENABLED<< " flight custom_mode: " << px4_mode.data;
            found = true;
            break;
        }
    }
