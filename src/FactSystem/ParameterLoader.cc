...
void ParameterLoader::_writeParameterRaw(int componentId, const QString& paramName, const QVariant& value)
{
    ...
    qWarning()<<"--mavlink_msg_param_set_encode = "<< p.param_value;
    qWarning()<<"--paramName.toStdString().c_str()="<< paramName.toStdString().c_str();
    qWarning()<<"--mavlink_msg_param_set_encode = "<< p.param_type;
    mavlink_message_t msg;
