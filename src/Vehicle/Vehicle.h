...
public:
    ...
    Q_PROPERTY(bool                 takeoffOrLanddown       READ takeoffOrLanddown  WRITE settakeoffOrLanddown      NOTIFY takeoffOrLanddownChanged)
    Q_PROPERTY(int                  ledColor                READ ledColor           WRITE settLedColor              NOTIFY ledColorChanged)
    Q_PROPERTY(int                  spinDirection           READ spinDirection      WRITE setSpinDirection          NOTIFY spinDirectionChanged)
    Q_PROPERTY(int                  throwFly                READ throwFly           WRITE setThrowFly               NOTIFY throwFlyChanged)
    Q_PROPERTY(int                  speedAmount             READ speedAmount        WRITE setSpeedAmount            NOTIFY speedAmountChanged)
    ...
    bool takeoffOrLanddown(void) { return _takeoffOrLanddown; }
    void settakeoffOrLanddown(bool takeoffOrLanddown);

    int ledColor(void){return _ledColor;}
    void settLedColor(int ledColor);

    int spinDirection(void){return _spinDirection;}
    void setSpinDirection(int spinDirection);

    int throwFly(void){return _throwFly;}
    void setThrowFly(int throwFly);

    int speedAmount(void){return _speedAmount;}
    void setSpeedAmount(int speedAmount);
...
signals:
    ...
    void takeoffOrLanddownChanged(bool takeoffOrLanddown);
    void ledColorChanged(int ledColor);
    void throwFlyChanged(int throwFly);
    void spinDirectionChanged(int spinDirection);
    void speedAmountChanged(int speedAmount);
...
private:
    ...
    bool    _takeoffOrLanddown;  ///<true or 1: we want to takeoff the vehicle; false or 0: we want to landdown the vehicle
    int     _ledColor;      ///diffenent int number represent different RGB color, eg. 1.white 2.blue 3.green 4.red 0.default color (maybe blue)
    int     _spinDirection; ///0:keep heading, 1:clockwise, 2:counterclockwise
    int     _throwFly;      ///0:normal, 1:ready to throw for fly
    int     _speedAmount;   ///30:slow speed mode, 60:middle speed mode, 100:fast speed mode
