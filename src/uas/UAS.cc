...
void UAS::setExternalControlSetpoint(float roll, float pitch, float yaw, float thrust, quint16 buttons, int joystickMode)
{
    ...
    if (sendCommand) {
        ...
        if (joystickMode == Vehicle::JoystickModeAttitude) {
            QCoreApplication::quit(); // did not came here
            ...
            QCoreApplication::quit(); // did not fall in here
            ...
            QCoreApplication::quit(); // not here either
           ...
           // QCoreApplication::quit(); //not falling in
           ...
           // QCoreApplication::quit(); // falling here
