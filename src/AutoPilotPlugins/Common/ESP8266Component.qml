                        ...
                        Column {
                            ...
                            Row {
                                ...
                                QGCComboBox {
                                    id:             modeField
                                    width:          _secondColumn
                                    model:          controller.modeSelect
                                    currentIndex:   controller.modeIndex
                                    onActivated: {
                                        controller.modeIndex = index
                                    }
                                }
                            }
                            Row {
                            ...
                            Row {
                                spacing: ScreenTools.defaultFontPixelWidth
                                QGCLabel {
                                    text:           "WiFi Station SSID"
                                    width:          _firstColumn
                                    anchors.baseline: ssidStaField.baseline
                                    }
                                QGCTextField {
                                    id:             ssidStaField
                                    width:          _secondColumn
                                    text:           controller.wifiStaSSID
                                    maximumLength:  16
                                    onEditingFinished: {
                                        controller.wifiStaSSID = text
                                    }
                                }
                            }
                            Row {
                                ...
                                QGCTextField {
                                    id:             passwordStaField
                                    width:          _secondColumn
                                    text:           controller.wifiStaPassword
                                    maximumLength:  16
                                    onEditingFinished: {
                                        controller.wifiStaPassword = text
                                    }
                                }
                            }
                            Row {
